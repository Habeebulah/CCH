...
import org.grameenfoundation.cch.application.CCHDbHelper;
import org.grameenfoundation.cch.model.User;
import org.grameenfoundation.cch.model.User_Profile;
...
public class CCHProfilesPage extends Activity {
	...
	public void onRegisterClick(View view){
		...
		User_Profile p= new User_Profile(Integer.valueOf(staff_id),firstName,lastName,facilityId,type,supervisor,
			...
			db.addUserProfile(p);
			db.updateUser(u);
		Intent reset = new Intent(getApplicationContext(), CCHDashBoard.class);
